...
routerv1.route("/commander").post(auth_1.default, create_commander_1.default).get(auth_1.default, list_commander_1.default).put(update_commander_1.default);
routerv1.route("/director").post(auth_1.default, create_director_1.default).get(auth_1.default, list_director_1.default).put(update_director_1.default);
