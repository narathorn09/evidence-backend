...
const UpdateSceneInvestigator = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const update = yield invesModel_1.default.update(data);
        if (!update) {
            res.status(500).json({
                status: "500",
...
exports.default = UpdateSceneInvestigator;
