...
const UpdateTypeEvidence = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { type_e_id, type_e_name } = req.body;
        const data = { type_e_id, type_e_name };
        const response = yield typeEvidenceModel_1.default.update(data);
        if (!response) {
...
exports.default = UpdateTypeEvidence;
